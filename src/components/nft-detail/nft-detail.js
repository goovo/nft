                            ...
                            <div className="table-adj">
                                <div className="table-responsive">
                                    <table className="table table-sm table-borderless table-hover">
                                        <tbody className="">
                                            <tr>
                                                <th className="pl-0 w-40" scope="row"><strong>名称</strong></th>
                                                <td>{this.state.imageData_name[key]}</td>
                                            </tr>
                                            <tr>
                                                <th className="pl-0 w-40" scope="row"><strong>创作者</strong></th>
                                            ...
                                            <tr>
                                                <th className="pl-0 w-40" scope="row"><strong>网址</strong></th>
                                                <td>{this.state.imageData_url[key]}</td>
                                            </tr>
                                            <tr>
                                                <th className="pl-0 w-40" scope="row"><strong>描述</strong></th>
                                        ...
                                        (
                                            <form onSubmit={(event) => {
                                                ...
                                                <div className="d-flex">
                                                    <div className="w-75 my-1">Price in ZSK -</div>
                                                    <input
                                                        type='text'
